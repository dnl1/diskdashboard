...
clear
echo -e "\033[34mdiskdashboard installer\033[0m"
echo -e "\033[34m=================\033[0m"
echo -e "\033[34mdiskdashboard\033[0m"
echo ""
...
echo -e "\033[1;33m[INFO]\033[0m Building diskdashboard..."
if ! cargo build --release; then
    echo -e "\033[0;31m[ERROR]\033[0m Failed to build diskdashboard."
    exit 1
fi

echo -e "\033[1;33m[INFO]\033[0m Installing diskdashboard to /usr/local/bin..."
if ! cp target/release/diskdashboard /usr/local/bin/diskdashboard; then
    echo -e "\033[0;31m[ERROR]\033[0m Failed to install diskdashboard."
    exit 1
fi

if ! chmod +x /usr/local/bin/diskdashboard; then
    echo -e "\033[0;31m[ERROR]\033[0m Failed to make diskdashboard executable."
    exit 1
fi

echo -e "\033[36m[SUCCESS]\033[0m Installation complete!"
echo -e "\033[1;33m[INFO]\033[0m You can now run 'diskdashboard' from anywhere."
echo -e "\033[1;33m[USAGE]\033[0m To run the diskdashboard, simply type: diskdashboard"
echo -e "\033[1;33m[USAGE]\033[0m For help run diskdashboard -h"
