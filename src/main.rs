...
fn main() {
    let matches = Command::new("diskdashboard")
        .version(VERSION)
        .author("dnl1")
    ...
    if matches.get_flag("help") {
        ...
        println!();
        println!("USAGE:");
        println!("    diskdashboard [OPTIONS] [PATH]");
        println!("    diskdashboard --disk <DISK> [OPTIONS]");
        println!("    diskdashboard -f <FILE> | --file <FILE>");
        println!("    diskdashboard -d <DIR> | --directory <DIR>");
        println!();
        println!("ARGS:");
